...
```json
{
  ...
  "data": {
    "name": "John Doe",
    "signature": "abc123xyz",
    "avatar": "https://ik.imagekit.io/flylive/avatars/user123.jpg",
    "frame": "frames/5",
    "gender": 1,
    "wealth_xp": "15000.000",
    "charm_xp": "8500.000",
...
| `avatar`         | `string\|null`  | ✅       | Single avatar URL (use Nuxt Image for transforms)       |
...
| ------- | ---------- | --------------------------------------------------------------------------------------------------------------- |
| 1.1     | 2026-01-16 | ⚠️ **Breaking**: Removed `total_gift_coins_sent`, `total_gift_coins_received`. Avatar is now single URL string. |
