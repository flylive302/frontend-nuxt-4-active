...
```json
{
  ...
  "data": {
    "prop": {
      ...
      "metadata": {
        // object|null, conditional - only if not null
        "animation_url": "https://cdn.fly.live/props/frame_001.webm",
        "rarity": "legendary"
      },
      "signature_value": "1234567" // string, conditional - ONLY present for type="signature"
    }
  },
  "meta": {
...
│ │   • is_available, is_purchasable (computed)                             │ │
│ │   • vip_level_required                                                  │ │
│ │   • metadata (conditional - only if not null)                           │ │
│ │   • signature_value (conditional - signature type only)                 │ │
│ └─────────────────────────────────────────────────────────────────────────┘ │
│                                                                             │
