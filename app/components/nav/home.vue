...
<template>
  <header class="nav-home-header fixed inset-x-0 top-0 z-50 px-2 pb-1 safe-area-top flex items-center justify-between backdrop-blur-lg border-b border-white/10 safe-area-top">
    <!-- Brand -->
    <NuxtImg
