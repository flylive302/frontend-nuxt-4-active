    ...
    <div v-if="currentStep" class="wizard-content flex-1 flex flex-col items-center">
      ...
      <template v-if="currentStep.id === 'gender'">
        ...
        <div class="grid grid-cols-2 gap-4 w-full max-w-88 mx-auto my-6">
          ...
          >
            <img :src="ASSETS.GENDER_FEMALE" alt="Female" class="gender-card__img w-full aspect-square object-contain rounded-xl">
          ...
          >
            <img :src="ASSETS.GENDER_MALE" alt="Male" class="gender-card__img w-full aspect-square object-contain rounded-xl">
