...
export const COLOR_CLASSES: Record<Colors, {
  ...
  primary:   { border: 'border-primary',   gradient: 'to-primary/30',   emphasis: 'ring-1 ring-primary/40' },
  secondary: { border: 'border-secondary', gradient: 'to-secondary/30', emphasis: 'ring-1 ring-secondary/40' },
  tertiary:  { border: 'border-tertiary',  gradient: 'to-tertiary/30',  emphasis: 'ring-1 ring-tertiary/40' },
  success:   { border: 'border-success',   gradient: 'to-success/30',   emphasis: 'ring-1 ring-success/40' },
  info:      { border: 'border-info',      gradient: 'to-info/30',      emphasis: 'ring-1 ring-info/40' },
  warning:   { border: 'border-warning',   gradient: 'to-warning/30',   emphasis: 'ring-1 ring-warning/40' },
  error:     { border: 'border-error',     gradient: 'to-error/30',     emphasis: 'ring-1 ring-error/40' }
}
