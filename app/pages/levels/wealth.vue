...
const data = ref<WealthLevelRow[]>([
  {
    level: 'Level 1',
    badge: {
      badgeSrc: '/siteAssets/badges/badge-wealth-level-1.webp',
      color: 'tertiary',
      txt: '1',
      class: '',
    },
  },
  {
    level: 'Level 2',
    badge: {
      badgeSrc: '/siteAssets/badges/badge-wealth-level-2.webp',
      color: 'tertiary',
      txt: '2',
      class: '',
    },
  },
  {
    level: 'Level 3',
    badge: {
      badgeSrc: '/siteAssets/badges/badge-wealth-level-3.webp',
      color: 'tertiary',
      txt: '3',
      class: '',
    },
...
<template>
  <main>
      ...
      <div class="p-2 w-full h-full bg-gradient-to-br to-tertiary/30">
        <div class="grid grid-cols-9 gap-1">
          ...
          <div class="col-span-2 flex flex-col justify-center">
            <ProfileBadge badge-src="/siteAssets/badges/badge-wealth-level-3.webp" class="ml-auto" color="tertiary" txt="1"/>
          </div>
        </div>
        <UProgress v-model="value" color="tertiary" />
        <div class="flex justify-between items-center">
          <p class="text-md font-bold">LvL: 1</p>
          <p class="text-md font-bold">LvL: 2</p>
        </div>
        <p class="text-base font-bold bg-elevated rounded-md border-2 border-tertiary px-2 py-1 leading-tight text-shadow-md">
          You have <span class="text-tertiary">9560.4 (XP)</span> You Need <span class="text-tertiary">1058.4 (XP)</span> Experience Points more to reach Level 2
        </p>
      </div>
    </AltHero>
    ...
    <div class="px-3 my-14">
      ...
      <UTable :columns="columns" :data="data" sticky class="border border-tertiary rounded-lg shadow-lg shadow-tertiary/30 mt-2 w-full" />
    </div>
  </main>
</template>