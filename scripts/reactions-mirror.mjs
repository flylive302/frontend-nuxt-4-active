 ...
 *   2. Optionally mirrors every emoji's `lottie.json` + `emoji.svg` from
...
/** `emoji.svg` is the static vector (~4KB) used by the drawer grid; `512.webp`
 *  is deliberately NOT mirrored — it is an *animated* WebP (~370KB) whose
 *  frames no CDN transform can strip, so it is unusable as a thumbnail. */
const FILES_PER_EMOJI = ['lottie.json', 'emoji.svg']
