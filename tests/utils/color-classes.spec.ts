...
import { COLOR_TEXT_CLASS, COLOR_BORDER_CLASS, COLOR_BG_10_CLASS, ACCENT_GRADIENT_CLASS } from '../../app/utils/color-classes'
...
describe('color class maps', () => {
  it.each([
    ...
    ['accent gradient', ACCENT_GRADIENT_CLASS, /^from-([a-z]+) to-\1\/10$/],
