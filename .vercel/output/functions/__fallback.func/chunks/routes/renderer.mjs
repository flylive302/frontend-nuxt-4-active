...
import { b as buildAssetsURL, u as useRuntimeConfig, a as getResponseStatusText, c as getResponseStatus, e as decodePath, f as defineRenderHandler, p as publicAssetsURL, h as getQuery, i as createError, j as destr, k as getRouteRules, l as joinURL, m as useNitroApp } from '../nitro/nitro.mjs';
...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"initial-scale=1, viewport-fit=cover, width=device-width"},{"name":"theme-color","content":"#ff2465"},{"name":"mobile-web-app-capable","content":"yes"},{"name":"apple-mobile-web-app-status-bar-style","content":"black-translucent"},{"name":"apple-mobile-web-app-title","content":"FlyLive"}],"link":[{"rel":"manifest","href":"/manifest.webmanifest"},{"rel":"apple-touch-icon","href":"/apple-touch-icon.png"},{"rel":"icon","type":"image/x-icon","href":"/favicon.ico"}],"style":[],"script":[],"noscript":[],"htmlAttrs":{"class":"dark"},"title":"FlyLive"};
